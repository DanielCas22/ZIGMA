                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-success btn-sm" 
                                                            onclick="aprobar(<?php echo $hora['id']; ?>, '<?php echo htmlspecialchars($hora['nombre'] . ' ' . $hora['apellido']); ?>')">
                                                        <i class="fas fa-check"></i> Aprobar
                                                    </button>
                                                    <button type="button" class="btn btn-danger btn-sm" 
                                                            onclick="rechazar(<?php echo $hora['id']; ?>, '<?php echo htmlspecialchars($hora['nombre'] . ' ' . $hora['apellido']); ?>')">
