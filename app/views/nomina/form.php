...
<head>
  <meta charset="UTF-8" />
  <title>Calcular Nómina - Filtros</title>
  ...
  <div class="container py-4">
    ...
    <div class="card p-3 shadow-sm">
      <form method="GET" action="/ZIGMA/public_nuevo/index.php">
        <input type="hidden" name="url" value="nomina/calcular" />
        ...
        <?php else: ?>
          ...
          <div class="alert alert-info">Se calculará la nómina para tu usuario.</div>
        <?php endif; ?>
