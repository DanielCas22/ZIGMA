                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            ...
                            <?php
                            $rol_nombre = strtolower($empleado['cargo'] ?? $empleado['rol_nombre'] ?? 'Sin rol');
                            ...
                            ?>
                            <i class="fas fa-briefcase me-1"></i> <span class="badge <?= $badge_class ?>"><?= htmlspecialchars($empleado['cargo'] ?? $empleado['rol_nombre'] ?? 'No especificado') ?></span>
                        </p>
                    </div>
                    <div>
